...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("SMM Manager || Settings") ?></title>
    ...
    <body class="<?= $AuthUser ? ( $AuthUser->get("preferences.dark_mode_status") ? ( $AuthUser->get("preferences.dark_mode_status") == "1" ? "darkside" : "" ) : "" ) : "" ?>">
        ...
        <script type="text/javascript" src="<?= PLUGINS_URL ."/smm-manager/assets/js/core.js?v=33".VERSION?>"></script>

        <script type="text/javascript" charset="utf-8">
            $(function(){
                SmmManager.SettingsTogglers();
            })
        </script>
        <?php if( isset($_GET['msg']) && $_GET['msg'] == "default_service_updated" ) : ?>
            <script type="text/javascript" charset="utf-8">
                 NextPost.Alert({
                    title: "Default Service has been Updated",
                    content: "<div >Need to set the <p style='color:#ff9b00; display:inline; font-weight:bold'>Default Quantity</p> of current service</div>",
                    confirmText: "OK",
                    confirm: function () {
